...
VALUES ('account.creation_enabled',
        'true',
...
VALUES ('banner.welcome', '
        ...
        ║                                                              ║
        ║   An llm enabled text-based multiplayer simulation in Rust   ║
        ║                                                              ║
        ╚══════════════════════════════════════════════════════════════╝
...
INSERT INTO wyldlands.settings (key, value, description, created_at, updated_at)
VALUES ('banner.logout',
        'Thank you for playing Wyldlands! Come back soon!
        ', 'Disconnection Banner', NOW(), NOW())
ON CONFLICT (key) DO NOTHING;

INSERT INTO wyldlands.accounts (id, login, display, password, role)
