...
//!
//! ```rust
//! use wyldlands_server::llm::{LLMRequest, LLMMessage, CharacterContext};
//!
...
///
/// ```rust
/// use wyldlands_server::llm::LLMMessage;
///
...
///
/// ```rust
/// use wyldlands_server::llm::AvailableCommand;
///
...
///
/// ```rust
/// use wyldlands_server::llm::{CharacterContext, AvailableCommand};
///
/// let context = CharacterContext::new()
...
impl CharacterContext {
    ...
    ///
    /// ```rust
    /// use wyldlands_server::llm::CharacterContext;
    ///
    /// let context = CharacterContext::new()
    ///     .with_name("Gandalf")
...
impl LLMRequest {
    ...
    ///
    /// ```rust
    /// use wyldlands_server::llm::LLMRequest;
    ///
    /// let request = LLMRequest::new("gpt-4");
    /// ```
    ...
    ///
    /// ```rust
    /// use wyldlands_server::llm::{LLMRequest, CharacterContext};
    ///
    /// let context = CharacterContext::new()
    ///     .with_name("Elara")
    ///     .with_personality("Wise wizard");
...
///
/// ```rust
/// use wyldlands_server::llm::LLMResponse;
///
...
///
/// ```rust
/// use wyldlands_server::llm::LLMConfig;
///
...
mod tests {
    ...
    fn test_llm_request_context_prepends_to_existing_system() {
        ...
        assert!(request.messages[0].content.contains("You are in a fantasy world"));
    }
