...
pub async fn room_generate_command(
    ...
    let default_provider = llm_manager.get_default_llm_provider().await;
    ...
    let request = llm_manager
        .create_llm_request_with_system("gpt-3.5-turbo", system_prompt, &prompt)
        ...
        Ok(response) => {
            ...
            match serde_json::from_str::<serde_json::Value>(&response.content) {
                Ok(json) => {
                    ...
                    let long_desc = json["long_desc"]
                        .as_str()
                        .unwrap_or("A room generated by AI.");
                ...
                Err(_) => {
                    ...
                    let _ = context
                        .insert_one(
                            room_entity,
                            Description::new(&response.content, &response.content),
                        )
                        .await;
                    context.mark_entity_dirty(room_entity).await;
        ...
        Ok(response) => {
            ...
            match serde_json::from_str::<serde_json::Value>(&response.content) {
                Ok(json) => {
                    ...
                    let long_desc = json["long_desc"]
                        .as_str()
                        .unwrap_or("An item generated by AI.");
                    let keywords: Vec<String> = json["keywords"]
                        .as_array()
                        .map(|arr| {
                            arr.iter()
        ...
        Ok(response) => {
            ...
            match serde_json::from_str::<serde_json::Value>(&response.content) {
                Ok(json) => {
                    ...
                    let long_desc = json["long_desc"]
                        .as_str()
                        .unwrap_or("An NPC generated by AI.");
                    let keywords: Vec<String> = json["keywords"]
                        .as_array()
                        .map(|arr| {
                            arr.iter()
